...
import io.github.weimin96.manager.server.ui.extensions.UiExtensionsScanner;
import io.github.weimin96.manager.server.ui.extensions.UiRoutesScanner;
...
public class AdminServerUiAutoConfiguration {
	...
	UiExtensions uiExtensions() throws IOException {
		...
		uiExtensions.forEach((e) -> log.info("Loaded Server Manager UI Extension: {}", e));
		return uiExtensions;
	}
